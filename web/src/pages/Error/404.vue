		...
		<div class="container d-flex align-items-stretch ui-mh-100vh p-0">
			<div class="row w-100">
				<div class="d-flex col-md justify-content-center align-items-center order-2 order-md-1 position-relative p-5">
					<div class="error-bg-skew bg-white" style="z-index:1"></div>

					<div class="text-md-left text-center" style="z-index:2">
						...
						<button type="button" @click="$router.go(-1)" class="btn btn-primary">←&nbsp; Go Back</button>
					</div>
				</div>
