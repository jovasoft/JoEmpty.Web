<template>
	<form class="card">
		<div class="p-4 p-sm-5">
			...
			<b-form-group>
				<b-input v-model="email" @blur="$v.email.$touch()" placeholder="Enter your email address" />
			...
			<b-btn variant="primary" :block="true" :disabled="$v.$invalid">Send password reset email</b-btn>
		</div>
	</form>
</template>
